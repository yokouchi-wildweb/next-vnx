...
export const SpNavigation = ({
  ...
  return (
    <AnimatePresence>
      {isOpen ? (
        <motion.div id="header-sp-nav" key="mobile-navigation" className="sm:hidden">
          <div id="header-sp-nav-container" className="fixed inset-x-0 bottom-0" style={{ top: headerOffset }}>
